...
RbsLib::Storage::FileType::FileType RbsLib::Storage::StorageFile::GetFileType(void) const
{
	...
	case std::filesystem::file_type::block:
		return RbsLib::Storage::FileType::Block;
...
{
	if (this->GetFileType() != RbsLib::Storage::FileType::Block) throw RbsLib::Storage::StorageException("File type error", RbsLib::Storage::StorageException::Reason::FileTypeError);
	this->PermissionException(RbsLib::Storage::FilePermission::Read);
...
RbsLib::Storage::FileIO::File RbsLib::Storage::StorageFile::Open(RbsLib::Storage::FileIO::OpenMode open_mode, RbsLib::Storage::FileIO::SeekBase default_seek, int64_t default_offset)
{
